...
extensions = [
    ...
    Extension("USPEX.Expressions.Private.ConvexHull", ["USPEX/Expressions/Private/ConvexHull.py"]),
    Extension("USPEX.Expressions.Private.paretoRanking", ["USPEX/Expressions/Private/paretoRanking.py"]),
    Extension("USPEX.Expressions.Private.Antiseeds", ["USPEX/Expressions/Private/Antiseeds.py"]),
    ...
    Extension("USPEX.Atomistic.Primitives.AtomicStructure", ["USPEX/Atomistic/Primitives/AtomicStructure.py"]),
    Extension("USPEX.Atomistic.Primitives.Element", ["USPEX/Atomistic/Primitives/Element.py"]),
    Extension("USPEX.Atomistic.Primitives.Cell", ["USPEX/Atomistic/Primitives/Cell.py"]),
    Extension("USPEX.Atomistic.Atomistic", ["USPEX/Atomistic/Atomistic.py"]),
    ...
    Extension("USPEX.Atomistic.Environments.Interface", ["USPEX/Atomistic/Environments/Interface.py"]),
    Extension("USPEX.Atomistic.Environments.Substrate", ["USPEX/Atomistic/Environments/Substrate.py"]),
    Extension("USPEX.Atomistic.Environments.Bulk", ["USPEX/Atomistic/Environments/Bulk.py"]),
    Extension("USPEX.Atomistic.Environments.NanoparticleCore", ["USPEX/Atomistic/Environments/NanoparticleCore.py"]),
    Extension("USPEX.Atomistic.Environments.slabFunctions", ["USPEX/Atomistic/Environments/slabFunctions.py"]),
