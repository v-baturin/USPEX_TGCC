...
class CompositionSpace_Test(unittest.TestCase):
    ...
    def test_fixed(self):
        ...
        self.assertTrue(config.isGoodComposition(self.extension.composition(self.system1)))
        self.assertFalse(config.isGoodComposition(self.extension.composition(self.system2)))
        self.assertFalse(config.isGoodComposition(self.extension.composition(self.system3)))
        self.assertFalse(config.isGoodComposition(self.extension.composition(self.system4)))
