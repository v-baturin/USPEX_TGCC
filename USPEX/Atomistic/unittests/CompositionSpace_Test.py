...
class CompositionSpace_Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.system1 = AtomisticPoolEntry(extensions=extensions, **AtomisticRepresentation.readAtomicStructure(PATH_WITH_TESTS/'system1.vasp'))
        self.system2 = AtomisticPoolEntry(extensions=extensions, **AtomisticRepresentation.readAtomicStructure(PATH_WITH_TESTS/'system2.vasp'))
        self.system3 = AtomisticPoolEntry(extensions=extensions, **AtomisticRepresentation.readAtomicStructure(PATH_WITH_TESTS/'system3.vasp'))
        self.system4 = AtomisticPoolEntry(extensions=extensions, **AtomisticRepresentation.readAtomicStructure(PATH_WITH_TESTS/'system4.vasp'))
