...
from ...components import AtomisticRepresentation, Bonds, BondHardnessUtility


class BondHardnessUtility_TestHardness(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
        cls.bonds = Bonds()
        cls.bondHardnessUtility = BondHardnessUtility()
    ...
    def test_graphite(self):
        ...
        H = self.bondHardnessUtility.calcHardness(graphite, bonds)
    ...
    def test_aluminium(self):
        ...
        H = self.bondHardnessUtility.calcHardness(system, bonds)
    ...
    def test_diamond(self):
        ...
        H = self.bondHardnessUtility.calcHardness(diamond, bonds)
...
class BondHardnessUtility_TestSoftModes(unittest.TestCase):
    def setUp(self):
        self.CURRENT_DIR = os.path.dirname(os.path.abspath(__file__))
        self.bonds = Bonds()
        self.bondHardnessUtility = BondHardnessUtility()

    def test_MgAlO_system_1(self):
        system = AtomisticRepresentation.readPOSCAR(self.CURRENT_DIR + '/MgAlO_system_1.vasp')
        bonds = self.bonds.getMinimalGraphBonds(system)
        freq, eigvector = self.bondHardnessUtility.calcSoftModes(system, bonds)
    ...
    def test_graphite(self):
        graphite = AtomisticRepresentation.readPOSCAR(self.CURRENT_DIR + '/graphite.POSCAR')
        bonds = self.bonds.getMinimalGraphBonds(graphite)
        freq, eigvector = self.bondHardnessUtility.calcSoftModes(graphite, bonds)
    ...
    def test_diamond(self):
        diamond = AtomisticRepresentation.readPOSCAR(self.CURRENT_DIR + '/diamond.POSCAR')
        bonds = self.bonds.getMinimalGraphBonds(diamond)
        freq, eigvector = self.bondHardnessUtility.calcSoftModes(diamond, bonds)
