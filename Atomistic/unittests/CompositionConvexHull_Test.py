...
class CompositionConvexHull_Test(unittest.TestCase):
    ...
    def test_unocomponent(self):
        ...
        self.convexHull.extend([(1, system1)])
        self.assertEqual(len(self.convexHull.lower_bound), 1)

        self.convexHull.extend([(2,system2)])
        self.assertEqual(len(self.convexHull.lower_bound), 1)
        self.assertEqual(self.convexHull.lower_bound, {2})
        self.assertAlmostEqual(self.convexHull.height(1), 2.0)
        self.assertEqual(self.convexHull.upper_bound, {1})
        self.assertAlmostEqual(self.convexHull.depth(2), -2.0)

        self.convexHull.extend([(3,system3)])
        self.assertEqual(len(self.convexHull.lower_bound), 1)
        self.assertEqual(self.convexHull.lower_bound, {2})
        self.assertAlmostEqual(self.convexHull.height(1), 2.0)
        self.assertAlmostEqual(self.convexHull.height(3), 3.0)
        self.assertEqual(self.convexHull.upper_bound, {3})
        self.assertAlmostEqual(self.convexHull.depth(1), -1.0)
        self.assertAlmostEqual(self.convexHull.depth(2), -3.0)
    ...
    def test_bicomponent(self):
        ...
        self.convexHull.extend([(3, system3)])
        self.assertEqual(len(self.convexHull.lower_bound), 2)
        self.assertEqual(self.convexHull.lower_bound, {2, 3})
        self.assertAlmostEqual(self.convexHull.height(1), 0.642857)

        ans = self.convexHull.height(4)
        self.assertTrue(np.isinf(ans) and ans > 0)
        self.convexHull.extend([(4, system4)])
        self.assertEqual(len(self.convexHull.lower_bound), 2)
        self.assertEqual(self.convexHull.lower_bound, {2,4})
        self.assertAlmostEqual(self.convexHull.height(1), 0.642857)
        self.assertAlmostEqual(self.convexHull.height(3), 0.275)

        ans = self.convexHull.height(5)
        self.assertTrue(np.isinf(ans) and ans > 0)
        self.convexHull.extend([(5,system5)])
        self.assertEqual(len(self.convexHull.lower_bound), 2)
        self.assertEqual(self.convexHull.lower_bound, {2, 5})
        self.assertAlmostEqual(self.convexHull.height(1), 0.642857)
        self.assertAlmostEqual(self.convexHull.height(3), 0.35)
        self.assertAlmostEqual(self.convexHull.height(4), 0.25)

        self.convexHull.extend([(4, system4)])
        self.assertEqual(len(self.convexHull.lower_bound), 2)

        ans = self.convexHull.height(6)
        self.assertTrue(np.isinf(ans) and ans > 0)
        self.convexHull.extend([(6, system6)])
        self.assertEqual(len(self.convexHull.lower_bound), 3)
        self.assertEqual(self.convexHull.lower_bound, {2, 5, 6})
        self.assertAlmostEqual(self.convexHull.height(1), 0.642857)
        self.assertAlmostEqual(self.convexHull.height(3), 0.35)
        self.assertAlmostEqual(self.convexHull.height(4), 0.25)
        ...
        self.convexHull.extend([(7,system7)])
        self.assertEqual(len(self.convexHull.lower_bound), 3)
        self.assertEqual(self.convexHull.lower_bound, {2, 5, 6})
        self.assertAlmostEqual(self.convexHull.height(1), 0.642857)
        self.assertAlmostEqual(self.convexHull.height(3), 0.35)
        self.assertAlmostEqual(self.convexHull.height(4), 0.25)
        self.assertAlmostEqual(self.convexHull.height(7), 0.58)

        self.convexHull.extend([(8,system8)])
        self.assertEqual(len(self.convexHull.lower_bound), 3)
        self.assertEqual(self.convexHull.lower_bound, {5, 6, 8})
        self.assertAlmostEqual(self.convexHull.height(1), 1.128571)
        self.assertAlmostEqual(self.convexHull.height(2), 0.485714)
        self.assertAlmostEqual(self.convexHull.height(3), 0.916667)
        self.assertAlmostEqual(self.convexHull.height(4), 0.25)
        self.assertAlmostEqual(self.convexHull.height(7), 1.033333)
    ...
    def test_bicomponent1(self):
        ...
        self.convexHull.extend([(i, x) for i,x in enumerate(systems)])

        self.assertEqual(self.convexHull.lower_bound, {4, 5, 7})
        self.assertEqual(self.convexHull.upper_bound, {0, 3, 5, 6})
    ...
    def test_bicomponent2(self):
        ...
        self.assertEqual(self.convexHull.lower_bound, {0,1,2,4,5})
        self.assertEqual(self.convexHull.upper_bound, {2,5})
        self.convexHull.clean()
        # ans = self.convexHull[system1]
        # self.assertTrue(np.isinf(ans) and ans < 0)
        # self.convexHull.add(system1)
    ...
    def test_bicomponent3(self):
        ...
        self.assertEqual(self.convexHull.lower_bound, {1,2,3})
        self.assertEqual(self.convexHull.upper_bound, {0,4})
        self.convexHull.clean()
