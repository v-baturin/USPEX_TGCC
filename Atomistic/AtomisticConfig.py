...
class ChemicalConfig(Config):
    ...
    def __init__(self, symbols: list, volumeType: str=None, ionDistances: dict=None, goodBonds: list=None,
                 valences: list=None, minVectorLength: float=None, valenceElectrons: list=None,
        ...
        if valenceElectrons is not None:
            ...
            self.valenceElectrons = np.asarray([Element(symbol).valence_electrons for symbol in self.chemicalSymbols],
                                               dtype=int)
